...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Signer Role/Page_BRICaMS Cash  Trade/span_Send for Rework'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Signer Role/Pop up Send For Rework/Others Click Box'))
...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Signer Role/Pop up Not Approve/span_Send Task for Rework'))
