...
String endPeriod = ExcelKeywords.getCellValueByAddress(sheet, 'E' + cell)
...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Recurring input_Amount_transactionScheduleType'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Drop down Select Frequency Recurring'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Select Daily Frequency'))

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/input start Period'), 
   startPeriod)
...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Dropdown Select Recurring Time'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Select Recurring Time'))

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/IFT/Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/input end Period'), 
   endPeriod)
