...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Button Delete'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Button Confirm Delete'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Close Button Delete'))
