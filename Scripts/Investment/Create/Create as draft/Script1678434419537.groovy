...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/Create/Select Input Source Account'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Page_BRICaMS Cash  Trade/Investment/Create/Select Input Source Account'), 'CA DEPO' + Keys.ENTER)

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/Create/button_CheckBalance'))

errorMessage = WebUI.getText(findTestObject('Page_BRICaMS Cash  Trade/Investment/Create/error 404'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Investment/Create/input_IDR_amount'), '1100000')
...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/Create/button_SaveAsDraft'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/Create/button_Close Save As Draft'))
