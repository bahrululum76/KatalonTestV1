...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Investment/input search table'), depositNo)

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

WebUI.clearText(findTestObject('Page_BRICaMS Cash  Trade/Investment/input search table'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/button Download'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/button Download CSV'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/button Download'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/button Download Excel (.xls)'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/button Download'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Investment/button Download PDF'))
