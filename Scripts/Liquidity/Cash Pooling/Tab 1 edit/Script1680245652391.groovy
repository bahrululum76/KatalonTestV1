...
String Waktu = ExcelKeywords.getCellValueByAddress(sheet, 'G' + cell)
...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/History/Filter/status'), 'draf')
...
not_run: WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Company Group'), CompanyGroup + 
    Keys.ENTER)

not_run: WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Company'), Company + Keys.ENTER)

not_run: WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Schema Description'), Desc)

not_run: WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Edit/Tab 1/Input Cur'), Cur + Keys.ENTER)
...
WebUI.clearText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input StarDate'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Edit/Tab 1/Input Type'), CashflowType + Keys.ENTER)

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Cashflow periode'), Periode + Keys.ENTER)

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Time'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Time'), Waktu + Keys.ENTER)
