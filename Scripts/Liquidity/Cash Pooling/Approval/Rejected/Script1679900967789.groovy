...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Approval/Reject/Button Reject Icon'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Approval/Reject/Reason reject'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Approval/Reject/Button Reject'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Approval/Reject/Done Reject'))
