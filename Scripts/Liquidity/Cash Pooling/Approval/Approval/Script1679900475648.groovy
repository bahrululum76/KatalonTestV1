...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Approval/Approve/Button Approve icon'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Approval/Approve/Button approve'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Approval/Approve/Button done Approve'))
