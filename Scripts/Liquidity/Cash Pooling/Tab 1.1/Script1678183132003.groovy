...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input every few day'), PeriodeOther + Keys.ENTER)

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Time 1.1'), Time + Keys.ENTER)
