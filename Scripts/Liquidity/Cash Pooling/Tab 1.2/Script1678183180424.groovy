...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input select day'), PeriodeOther + Keys.ENTER)

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Create/Tab 1/Input Time 1.2'), Time + Keys.ENTER)
