...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Delete/Button delete'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Delete/Confirm delete'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Liquidity/LM/Delete/Done delete'))
