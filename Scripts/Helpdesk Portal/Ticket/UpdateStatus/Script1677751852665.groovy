...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Helpdesk Portal/Update/Select Admin'))

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Helpdesk Portal/Update/Select Admin'), admin + Keys.ENTER)
