...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Helpdesk Portal/Filter/Input Tiket No'), TicketNo)
...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Helpdesk Portal/Filter/Input Subject'), Subject)
...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Helpdesk Portal/Filter/Input Module'), Module + Keys.ENTER)
...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Helpdesk Portal/Filter/Input DateCreated'), DateCreated + Keys.ENTER)
...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Helpdesk Portal/Filter/Input DateModified'), DateModif + Keys.ENTER)
